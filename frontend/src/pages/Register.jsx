  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      <motion.div 
        ...
        className="absolute bottom-1/4 -right-20 w-96 h-96 bg-primary-400/30 rounded-full blur-3xl pointer-events-none"
      />
      <motion.div 
        animate={{ scale: [1, 1.3, 1], y: [0, 50, 0] }} 
        transition={{ duration: 20, repeat: Infinity }}
        className="absolute top-1/4 -left-20 w-96 h-96 bg-indigo-400/20 rounded-full blur-3xl pointer-events-none"
      />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Join AlgoSplit to share expenses easily</p>
        </div>
